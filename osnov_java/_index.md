...
Java является объектно-ориентированным языком программирования. Основные принципы ООП в Java:
...
Сами методы `public`, а значит получить к ним доступ возможно из любой области программы. Таким образом поучив их или изменив. Мы сами задаем сценарий работы с данным полем.
...
<mark style="color: #BDB76B;">Один класс - один родитель.</mark>
...
Для этого в классе наследнике перед переопределяемым методом ставится анотация **@Override**:
...
• **Полиморфизм**: Одна и та же функция или метод может работать разными способами в зависимости от контекста.
