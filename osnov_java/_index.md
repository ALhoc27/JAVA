...
(*это как проект здания, в проекте всегда есть атрибуты (поля), так же могут быть методы (инструкции) (действия с теми или иными полями, например расчет стоимости) - методы*)