...
**Переопределение методов (Method Over**riding):
...
**Полиморфизм** - возможность применения одноименных методов с одинаковыми или различными наборами параметров в одном классе или в группе классов, связанных отношением наследования (в том числе implements - наследование от интерфейсов).
