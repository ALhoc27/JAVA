...
В Java, полиморфизм реализуется *с помощью наследования/имплементирования классов и интерфейсов, их* **переопределения***, а так же с помощью* **перегрузки***.*
...
[image:./osnov_java-4.png:::0,0,100,100:39:]
...
**Alexander Babitsky**9 months ago

1. :ul metrics

`:code-block metrics`:card metrics:divider metrics
