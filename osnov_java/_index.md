...
В Java, полиморфизм реализуется с помощью наследования/имплементирования
 классов и интерфейсов,<strong> а именно с помощью переопределения и перегрузки.
 </strong>
</pre>

[/html]

В Java, полиморфизм реализуется *с помощью наследования/имплементирования классов и интерфейсов, а именно с помощью переопределения и перегрузки.*
