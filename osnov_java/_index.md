...
В Java, полиморфизм реализуется *с помощью наследования/имплементирования классов и интерфейсов(переопределения). А так же с помощью перегрузкой (В одном классе).*
